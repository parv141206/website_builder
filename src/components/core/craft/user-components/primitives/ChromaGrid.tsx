...
export const ChromaGrid: React.FC<ChromaGridProps> & { craft?: any } = ({
  items,
  className = "",
  radius = 300,
  damping = 0.45,
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "damping", type: "number", label: "Damping" },
            { key: "fadeOut", type: "number", label: "Fade Out" },
            {
              key: "ease",
              type: "text",
              label: "Ease",
              ...
              params: {
                itemType: {
                  ...
                  schema: [
                    ...
                    { key: "handle", type: "text", label: "Handle" },
                    ...
                    { key: "gradient", type: "text", label: "Gradient" },
